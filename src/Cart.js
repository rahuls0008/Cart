...
const Cart = (props) => {   //Cart will inherit some features from Component class in React package
        ...
        // const {products} = this.state;   //object destructuring to get the products
        const {products} = props;  // since we do not have access to "this.state" now
        
        //this.xxxxx (class based) ----> props.xxxxx (function based)
                ...
                {products.map((product) => {
                    return (
                        <CartItem 
                            ...
                            product = {product} 
                            key={product.id}
                            onIncreaseQuantity = {props.onIncreaseQuantity}     //pass the reference of the function
                            onDecreaseQuantity = {props.onDecreaseQuantity}         //this.xxxxx (class based) ----> props.xxxxx (function based)
